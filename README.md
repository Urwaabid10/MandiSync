# MandiSync — Mango (آم) Market Intelligence Platform

Production-ready single-product market transparency dashboard for **Mango Chaunsa (چونسا آم)** in Pakistan. Bridging the information gap between farmers, arthis (commission agents), and bidders in the mandi ecosystem through real-time pricing, voice-driven updates, and RTL Urdu-first design.
...
| **Voice Updates (Groq Whisper)** | Arthi records voice notes → Groq Whisper v3 Turbo transcribes → Gemini AI extracts structured entities |
| **Settlement Slips** | Upload handwritten purchase list → Gemini Vision extracts bidder items → auto-calculates kacchi/pakhta bikri |
| **Crop Arrivals & Auction Notices** | Real-time arrival tracking with auction scheduling |
...
| گٹو (Gattu) | Large Container | ~40kg crate of mangoes |
| پیٹی (Peti) | Small Container | ~20kg box of mangoes |
